...
class QloMidtransCommerceWebhookModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if ($headers) {
            ...
            $payload['webhook_id'] = Configuration::get('WK_MIDTRANS_COMMERCE_SANDBOX_WEBHOOK_ID');
        }
